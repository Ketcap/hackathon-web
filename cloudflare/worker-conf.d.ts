// Generated by Wrangler by running `wrangler types --config ./cloudflare/wrangler.jsonc --path ./cloudflare/worker-conf.d.ts` (hash: 888c75865c79586971987189f86ae8bc)
// Runtime types generated with workerd@1.20250408.0 2025-04-08 
declare namespace Cloudflare {
	interface Env {
		CURSOR_ROOM: DurableObjectNamespace<import("./cursor").CursorRoom>;
	}
}
